...
(function () {
    ...
    function applyPremiumHero(config) {
        ...
        // #hero-searchbar leeft sinds de unified-header refactor BINNEN
        // .site-header (samen één sticky systeem). "afterend" van die
        // mount zou de hero dus binnen de sticky chrome plaatsen — wat
        // de hero visueel boven de categorie-nav duwt. Anchor daarom
        // altijd op .site-header zelf: dan landt de hero als sibling
        // direct ná de header (en ná de geïntegreerde categorie-nav).
    ...
    function ensureInspirationMount() {
        ...
        // Zelfde reden als bij applyPremiumHero: nooit #hero-searchbar
        // gebruiken als fallback-anchor, want die zit nu binnen
        // .site-header — anders landen de inspiratie-tabs binnen de
        // sticky chrome i.p.v. eronder. Gebruik de header zelf.
