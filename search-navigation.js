...
(function () {
    ...
    function detectInitialCategory() {
        try {
            ...
            // Homepage en neutrale discovery-pagina's: geen actieve categorie.
            // De underline mag alleen verschijnen wanneer de gebruiker
            // daadwerkelijk binnen een category-context zit.
            if (path.endsWith("/homepagina.html") ||
                path.endsWith("/index.html") ||
                path === "/" || path.endsWith("/")) return null;
    ...
    function collapsedBarHTML(state) {
        // GLOBAL REMOVAL — de oude "Begin je zoektocht" sn-bar pill is
        // platform-breed afgevoerd. De homepage gebruikt nu één
        // discovery-systeem (het Keuzehulp-blok), en contextuele pagina's
        // hebben hun eigen filter-UI. Wat hier blijft: alleen de drie
        // sticky categorie-tabs (Resorts & Hotels / Campings /
        // Vakantieparken) als top-strip onder de header.
        return `
            <div class="sn-bar-wrap sn-bar-wrap--tabsonly">
